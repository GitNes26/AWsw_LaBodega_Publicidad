         ...
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
               ...
               <ul class="nav nav-treeview text-sm">
                  ...
                  <li class="nav-item">
                     <a href="./Pages/videos.php" class="nav-link">
                        <i class="far fa-circle nav-icon text-sm"></i>
                        <p>Video Principal</p>
                     </a>
                  </li>
                  ...
                  <li class="nav-item">
                     <a href="./Pages/banvertical.php" class="nav-link">
                        <i class="far fa-circle nav-icon text-sm"></i>
                        <p>Banner Vertical</p>
                     </a>
                  </li>
                  ...
                  <li class="nav-item">
                     <a href="./Pages/banhorizontal.php" class="nav-link">
                        <i class="far fa-circle nav-icon text-sm"></i>
                  ...
                  <li class="nav-item">
                     <a href="./Pages/bancompleto.php" class="nav-link">
                        <i class="far fa-circle nav-icon text-sm"></i>
                        <p>Banner Completo</p>
                     </a>
                  </li>
                  ...
                  <li class="nav-item">
                     <a href="./Pages/texto.php" class="nav-link">
                        <i class="far fa-circle nav-icon text-sm"></i>
                        <p>Texto Cintilla</p>
                     </a>
                  </li>
            ...
            <li class="nav-item">
               ...
               <ul class="nav nav-treeview text-sm">
                  <li class="nav-item">
                     <a href="./Pages/reproductor.php" class="nav-link">
                        <i class="far fa-circle nav-icon text-sm"></i>
                        <p>Reproductor</p>
                     </a>
                  </li>
