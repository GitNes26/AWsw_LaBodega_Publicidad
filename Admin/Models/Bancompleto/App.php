...
if ($accion == 'crear_bancompleto') {
   $Bancompleto->crearBancompleto($ubicacion,$ruta,$tipo,$fecha_inicial,$fecha_final,$status);
}
...
if ($accion == "eliminar_bancompleto") {
   ...
   $Bancompleto->eliminarBancompleto($id,$path_a_eliminar);
}
...
if ($accion == "eliminar_archivo") {
   ...
   $Bancompleto->eliminarArchivoYruta($id,$path_a_eliminar);
}
