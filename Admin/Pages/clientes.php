                     ...
                     echo  "
                        <tr>
                           ...
                           <td class='align-middle'>
                              <button class='btn btn-primary btn_editar' data-bs-toggle='modal' data-bs-target='#modal' data-id='$objCliente[cli_id]'><i class='fa-solid fa-pen-to-square fa-lg'></i></button>
